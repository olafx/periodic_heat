...
void eval_coords_real_space(double *x, double *y, double *z, array<size_t, 3> n, array<double, 6> range)
...
void eval_coords_freq_space(double *k_x, double *k_y, array<size_t, 3> n, array<double, 6> range)
...
void eval_intensity_real_space(complex<double> *q, array<size_t, 3> n, double *x, double *y,
...
void eval_intensity_freq_space(complex<double> *q_dft, array<size_t, 3> n, complex<double> *q)
